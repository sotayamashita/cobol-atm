      ...
      *    -- 対外接続系 (5xxx)
      *       勘定系ホストと他行 (全銀システム)。まとめて 1 帯にするのは、
      *       宛先不明・接続不能・応答なしがまとまって発生し、係員の対処
      *       (相手への照会) も共通になるため。
      ...
      *       勘定系ホストが応答しない。記帳されたかどうかは端末には
      *       判らないので、取引照会で決着させる。決着しなければ
      *       係員対応。
           05  EC-HOST-NO-ANSWER       PIC X(04) VALUE '5004'.
